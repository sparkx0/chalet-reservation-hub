    ...
    <div className="relative h-screen">
      ...
      <div className="relative h-full flex items-center justify-center text-center text-white px-4">
        ...
        >
          ...
          <p className="text-xl md:text-2xl mb-4 text-snow-light">
            Un chalet d'exception vieux de 250 ans entre Genève et Annecy
          </p>
          <p className="text-lg md:text-xl mb-8 text-snow-light">
            Capacité d'accueil jusqu'à 14 personnes · Vue panoramique sur les Alpes
          </p>
          <a
            href="#reservation"
